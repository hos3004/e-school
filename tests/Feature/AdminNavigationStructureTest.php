...
final class AdminNavigationStructureTest extends TestCase
{
    ...
    public function test_no_legacy_group_label_survives(): void
    {
        ...
        $legacy = [
            ...
            'التقارير الأكاديمية', 'الحوكمة والأمان', 'الموظفون',
        ];

        /*
         * «التكاملات» كانت اسم مجموعة ملغاة، لكنها أيضًا جزء من تسمية عنصر
         * مشروعة («مزوّدو التكاملات»). المطابقة النصية لا تفرّق بين الاثنين،
         * فاستبعادها أصدق من إسقاط جولة على كلمة في محلّها.
         */
