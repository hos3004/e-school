...
return [
     ...
     *
     * `releasing_outcomes` هي نتائج التعويضية التي تعني أن المعلم أدّى عمله،
     * فتُحرَّر بها قيدة الأصلية المؤجَّلة ولا تُنشأ قيدة ثانية:
     *   makeup_completed  الحصة أُقيمت وحضر الطرفان.
     *   student_no_show   المعلم حضر ولم يحضر الطالب — أجره مستحق كاملًا.
     *   student_excused   غياب الطالب بعذر — المعلم حضر فيستحق أجره.
     *
     * ما عداها (غياب المعلم، إلغاؤه، اعتذاره) لا يحرّر شيئًا: تبقى القيدة
     * مؤجَّلة كما هي — لا تُحذف ولا تُعدَّل — وتسويتها قرار إداري بقيدة
     * `adjustment`، لأن الدفتر append-only ولأن القرار ليس آليًا.
     */
    'makeup' => [
        'releasing_outcomes' => ['makeup_completed', 'student_no_show', 'student_excused'],
    ],

    /*
     * معالجة التأجيلات التي مرّت بلا قيدة مؤجَّلة — دفعة واحدة لكل تشغيل.
     */
    'backfill' => [
        'batch_size' => 200,
    ],
