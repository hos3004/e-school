...
export default function ApplicationStatus({
  ...
  const content = (
    <>
      ...
      {application ? (
        ...
        <div
          className="mt-8 rounded-[var(--radius-lg)] border border-[color:var(--danger)]/30 bg-[var(--danger-soft)] p-6 text-center text-sm font-medium text-[var(--danger)]"
          role="alert"
        >
  ...
  return consoleRegistration ? (
    <PublicRegistrationLayout>
      <section className="pr-result-card">{content}</section>
    </PublicRegistrationLayout>
  ) : (
