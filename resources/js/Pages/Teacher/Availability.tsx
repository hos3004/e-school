...
export default function Availability({
    ...
    return (
        <AppLayout role="teacher">
            ...
            {loading ? (
                <LoadingState
                    label={t('teacher.availability.loading')}
                    rows={3}
                />
            ) : error ? (
                ...
                <EmptyState
                    ...
                    description={t(
                        'teacher.availability.no_profile_description',
                    )}
                />
            ) : (
                <div className="space-y-6">
                    <Card>
                        <CardHeader className="mb-5">
                            <CardTitle>
                                {t('teacher.availability.add_title')}
                            </CardTitle>
                            <CardDescription>
                    ...
                    <Card>
                        <CardHeader className="mb-4">
                            <CardTitle>
                                {t('teacher.availability.list_title')}
                            </CardTitle>
                        </CardHeader>
                        ...
                        {availability.length === 0 ? (
                            <EmptyState
                                ...
                                description={t(
                                    'teacher.availability.empty_description',
                                )}
                            />
                        ) : (
