 ...
 * إتاحة المعلم لنفسه.
 *
 * لا يوجد `staff_profile_id` بين القواعد عمدًا: المتحكم يشتقه من الجلسة،
 * وأي قيمة ترسلها الواجهة تُتجاهل.
 */
final class StoreOwnAvailabilityRequest extends FormRequest
{
