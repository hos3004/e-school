 ...
 * **اعتذار المعلم لا يُلغي الحصة.** بعد اعتماد المشرف يبدأ البحث عن بديل،
 * والحصة تبقى قائمة بحالتها. لذلك لا يوجد هنا أي عمود يُلغي حصة.
 *
 ...
 * القرار النهائي للإدارة يدوي دائمًا (client-answers §ك).
 */
