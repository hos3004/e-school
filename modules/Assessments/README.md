...
## عقد تحقق العودة للدراسة

ينشر `ReactivationAssessmentQueries` محاولات التقييم من نوع Reactivation المطابقة للمؤسسة والطالب ومعرّف طلب العودة في `ReactivationAssessmentData`، دون استيراد نموذج Discipline أو قراءة جدوله. يعيد الدرجة والنتيجة المعتمدة وتاريخ التصحيح فقط؛ تستخدمها واجهة المتابعة للتحقق قبل اعتماد العودة.
