...
## مرجع التوقيت للوحة الجديدة
العقد العام SchoolClockQueries يرجع منطقة المؤسسة وبداية أسبوعها دون كشف نموذجOrganization. إعداد week_starts_on قابل للحفظ من /manage/settings مع قفل التزامن والتدقيق.
