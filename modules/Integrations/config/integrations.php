...
return [
    ...
    */
    'webhooks' => [
        'max_attempts' => env('INTEGRATIONS_WEBHOOK_MAX_ATTEMPTS', 5),

        /*
        | مهلة الانتظار (بالدقائق) قبل إعادة المحاولة بعد فشل الإيصال.
        */
        'retry_backoff_minutes' => env('INTEGRATIONS_WEBHOOK_RETRY_BACKOFF_MINUTES', 15),
    ],
    ...
    'connections' => [
        ...
        */
        'max_per_provider' => env('INTEGRATIONS_CONNECTIONS_MAX_PER_PROVIDER', 1),
    ],
