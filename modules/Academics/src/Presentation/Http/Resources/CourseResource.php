...
final class CourseResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'session_mode' => $this->resource->session_mode->value,
            'target_gender' => $this->resource->target_gender?->value,
            'age_from' => $this->resource->age_from,
            'age_to' => $this->resource->age_to,
            'default_duration_minutes' => $this->resource->default_duration_minutes,
            'sessions_per_week' => $this->resource->sessions_per_week,
