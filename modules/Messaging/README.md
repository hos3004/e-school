...
- Webhook Green API عند /api/webhooks/green-api يتطلب Bearer token مطابقًا للمثيل، ويستنتج المؤسسة من الاتصال المخزن دون قبول organization_id من الطلب. يرد 200 على التكرار والأنواع غير المعالجة.
