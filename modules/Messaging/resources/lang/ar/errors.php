...
return [
    'invalid_participant_scope' => 'يجب أن يكون جميع المشاركين حسابات نشطة في المؤسسة نفسها.',
    'class_access_denied' => 'يقتصر الوصول إلى محادثة الصف على الأعضاء النشطين والمعلمين المكلفين.',
