...
/*
| General messages of the AcademicReports module.
| Consumed via __('academicreports::messages.key') — no user-facing text outside translation files.
*/
...
return [
    ...
    'demo_strengths' => 'Active participation and good engagement during the session.',
