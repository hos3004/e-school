...
final class NotificationPreferencePolicy
{
    ...
    public function view($user, NotificationPreference $preference): bool
    {
        return $user->can('notifications.preference.view')
            && $preference->organization_id === $user->organization_id;
    }

    public function viewOwn($user, NotificationPreference $preference): bool
    {
    ...
    public function update($user, NotificationPreference $preference): bool
    {
    ...
    public function updateOwn($user, NotificationPreference $preference): bool
    {
        return $preference->user_id === $user->id;
    }

    public function delete($user, NotificationPreference $preference): bool
    {
