...
return [
    ...
    'manual_recipient_not_found' => 'المستلم المحدد غير موجود أو غير نشط داخل مؤسستك.',
    'manual_empty_audience' => 'لا تضم المجموعة المحددة مستلمين نشطين داخل المؤسسة.',
    'manual_fields_required' => 'يلزم إدخال الموضوع والرسالة وسبب الإرسال.',
    'manual_request_invalid' => 'معرّف طلب الإرسال غير صالح؛ أعد فتح النموذج وحاول مجددًا.',
    'manual_schedule_past' => 'موعد الإرسال المختار مضى بتوقيتك. اختر موعدًا قادمًا.',
    'email_domain_undeliverable' => 'نطاق بريد المستلم محجوز ولا يُسلَّم إليه؛ لم تُفتح أي محاولة إرسال.',
];
