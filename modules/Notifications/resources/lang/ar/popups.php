...
return [
    ...
    'errors' => [
        ...
        'foreign_tenant' => 'لا يمكن حفظ حملة تابعة لمؤسسة أخرى.',
        'invalid_configuration' => 'بيانات الحملة غير مكتملة أو تحتوي قيمة غير معتمدة.',
        'invalid_action' => 'زر الإجراء أو رابطه غير صالح. الروابط الخارجية يجب أن تبدأ بـ HTTPS.',
