...
/** انتهى طلب تغيير الموعد الدائم دون تطبيق: رفض طالب أو سحب أو انقضاء مهلة. */
final class ScheduleChangeRejected extends DomainEvent
{
    /**
    ...
    {
        return 'scheduling.schedule_change_rejected';
    }
