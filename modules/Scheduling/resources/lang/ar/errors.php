...
return [
    ...
    'outside_makeup_window' => 'يجب أن تقع الحصة التعويضية خلال :days يومًا من الموعد الأصلي.',
    ...
    'teacher_unchanged' => 'المعلم المختار هو معلم الجدول الحالي بالفعل.',
    'course_already_scheduled' => 'للطالب جدول سارٍ في هذا الكورس بالفعل؛ غيّر معلمه أو أزله أولًا.',
    ...
    'schedule_not_found' => 'قالب الجدول غير موجود.',
    'schedule_not_assigned_to_teacher' => 'لا يمكنك طلب تغيير موعد جدول غير مسند إليك.',
    'group_slots_single_time' => 'حصص المجموعة تبدأ في ساعة واحدة لكل الأيام.',
    'schedule_change_not_different' => 'الموعد المقترح مطابق للموعد الحالي.',
    'schedule_change_already_pending' => 'يوجد طلب تغيير موعد معلّق لهذا الجدول بالفعل.',
    'schedule_change_no_students' => 'لا يوجد طلاب نشطون في هذا الجدول لأخذ موافقتهم.',
    'schedule_change_not_pending' => 'طلب تغيير الموعد لم يعد مفتوحًا للرد.',
