...
ينشر `DisciplineFollowupQueries` المخالفات وإجراءات الانضباط وطلبات العودة في `FollowupDisciplineData` ضمن المؤسسة والتسجيلات المحددة ونافذة السياسة. لا يقرأ جداول موديولات أخرى. يبقى WaiveViolationAction ومسار طلب العودة وقراره مصدر عمليات الكتابة.
