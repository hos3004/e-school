...
- أضيفت صفحة جدول متعددة الاختيار لتسكين عدة طلاب في القرآن الفردي، مع تخصيص
  خانة مستقلة غير متداخلة لكل طالب وربط الصفحة من قائمة قوالب الجداول.
- أتيح تسكين القرآن الفردي من طلبات التسجيل المقبولة، وأتيح التسكين الجماعي
  متعدد الطلاب من جدول الطلاب، مع صلاحيات صريحة واستبعاد الطلبات غير المقبولة.
