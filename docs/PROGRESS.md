...
- تنفيذ واختبار على SSH SCHOOL-WEB: استكمال إجباري للملف، إعدادات مدد وأجور المعلمين بالجنيه، وحفظ السعر وقت الحصة.
- اختبار تسكين 18 طالبًا في 49 موعدًا أسبوعيًا بتوقيت إسطنبول؛ 25 دقيقة للكبار و35 للأطفال، وربط أصحاب المواعيد الناقصة بمعلميهم بحالة انتظار.
